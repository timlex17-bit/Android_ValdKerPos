...
public class MechanicApi {
    ...
    public static final String ENDPOINT_MECHANICS = "api/workshop/mechanics/";
    ...
    public MechanicApi(@NonNull Context context) {
    ...
    public void list(@NonNull StringCallback callback) {
        StringRequest request = new StringRequest(
                Request.Method.GET,
                ApiConfig.url(session, ENDPOINT_MECHANICS),
                callback::onSuccess,
    ...
    public void create(@NonNull MechanicRequest body, @NonNull ObjectCallback callback) {
    ...
    public void update(int id, @NonNull MechanicRequest body, @NonNull ObjectCallback callback) {
        JsonObjectRequest request = new JsonObjectRequest(
                Request.Method.PATCH,
                ApiConfig.url(session, ENDPOINT_MECHANICS + id + "/"),
                body.toJson(),
                callback::onSuccess,
                error -> callback.onError(statusCode(error.networkResponse), buildErrorMessage(error.networkResponse, error))
        ) {
